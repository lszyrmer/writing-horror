...
export default function WritingCanvas({ text, onChange, noBackspaceMode, goalAchieved }: WritingCanvasProps) {
  ...
  return (
    <textarea
      ...
      onCopy={handleCopy}
      onCut={handleCut}
      className="w-full h-full bg-transparent text-gray-100 text-base sm:text-lg leading-relaxed resize-none outline-none border-none pl-4 sm:pl-8 pr-6 sm:pr-10 pt-4 sm:pt-8 pb-[140px] sm:pb-[200px] font-mono"
