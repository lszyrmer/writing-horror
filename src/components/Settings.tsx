...
export default function Settings({ onBack, onAudioChange, onTypewriterChange, onCustomTypewriterChange, onParagraphSoundChange }: SettingsProps) {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6">
          <div className="bg-dark-light border border-dark-lighter rounded-lg p-6">
            <h2 className="text-xl font-semibold text-gray-100 mb-4">Default Session Settings</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3 pt-2">
                ...
                <label htmlFor="defaultNoBackspace" className="text-gray-300 cursor-pointer select-none">
                  Enable No Backspace Mode by default
                </label>
              </div>
            </div>
          </div>
